 ...
 */
function opro_subtheme_preprocess_node(&$vars) {
  if (isset($vars['workbench_access'])) {
    $tempKey = array_keys($vars['workbench_access']); 
    $tempTerms = taxonomy_term_load_multiple($tempKey); 
    $tempTerm = array_pop($tempTerms); 
    $vars['program'] = $tempTerm->name;
  }
}
